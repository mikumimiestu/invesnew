...
int main()
{
    ...
    int initial_value = 5780; // Rp 5740 adalah harga awal bulan Oktober
    int final_value = 5700;

    // Menghitung peningkatan poin
    int point_increase = final_value - initial_value;
    printf("Point Increase: %d\n", point_increase);

    // Menghitung persentase peningkatan
    double percentage_increase = ((double)point_increase / initial_value) * 100;
